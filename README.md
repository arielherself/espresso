...
The ministers have decided to task the European Commission to come up with proposals to redistribute to consumers excess profits made by power, oil, and gas companies. The EU’s executive arm has also been asked to work on a price cap on Russian gas, which would lower the country’s revenues. It will also look into a platform for joint gas purchases and voluntary measures to limit peak electricity demand. Its proposals could come as early as next week.
