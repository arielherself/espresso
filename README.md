...
<strong>Alphabet</strong>, the parent company of Google, unveiled <strong>Bard</strong>, a [chatbot powered by artificial intelligence](https://te.arielherself.xyz/business/2023/01/30/the-race-of-the-ai-labs-heats-up). It will rival <strong>ChatGPT</strong> from OpenAI, a popular Microsoft-backed venture that generates text as if created by humans. Various firms plan to add similar technology, including Baidu, a Chinese search giant. Bard will be tested on some users before a full launch in the coming weeks.
