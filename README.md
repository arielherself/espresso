...
As expected America’s <strong>Federal Reserve</strong> [raised its benchmark interest rate](https://te.arielherself.xyz/graphic-detail/2022/11/02/inflation-is-too-high-when-the-public-notices-it) by three-quarters of a percentage point, the fourth consecutive jumbo increase. That brings the federal-funds rate to a range of 3.75-4.0%, its highest since 2008, and comes amid the central bank’s [battle against inflation](https://te.arielherself.xyz/finance-and-economics/2022/10/19/why-inflation-refuses-to-go-away), which hit 8.2% in September. Investors will scrutinise remarks from Jerome Powell, the Fed chair, on Wednesday for signs of whether the pace of tightening will ease next month.
